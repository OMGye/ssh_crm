									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#request.list" var="cus">
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer_delete?cid=<s:property value="#cus.cid"/>">删除</a>
													<a href="${pageContext.request.contextPath }/customer_showCustomer?cid=<s:property value="#cus.cid"/>">修改</a>
													</TD>
												</TR>
